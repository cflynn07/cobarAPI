...
(function() {
  ...
  module.exports = function(app) {
    var businessDivision0;
    businessDivision0 = ORM.model('businessDivision0');
    app.get(config.apiSubDir + '/v1/businessDivision0s', function(req, res) {
      return async.series([
        function(callback) {
          ...
          switch (userType) {
            case 'superAdmin':
              ...
              return apiExpand(req, res, businessDivision0, params);
    ...
    return app.get(config.apiSubDir + '/v1/businessDivision0s/:id', function(req, res) {
      return async.series([
        function(callback) {
          return apiAuth(req, res, callback);
        }, function(callback) {
