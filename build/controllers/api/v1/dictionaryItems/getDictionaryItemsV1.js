...
(function() {
  ...
  module.exports = function(app) {
    ...
    app.get(config.apiSubDir + '/v1/dictionaryItems', function(req, res) {
      return async.series([
        function(callback) {
          ...
          switch (userType) {
            case 'superAdmin':
              ...
              return apiExpand(req, res, dictionaryItem, params);
    ...
    return app.get(config.apiSubDir + '/v1/dictionaryItems/:id', function(req, res) {
      return async.series([
        function(callback) {
          return apiAuth(req, res, callback);
        }, function(callback) {
