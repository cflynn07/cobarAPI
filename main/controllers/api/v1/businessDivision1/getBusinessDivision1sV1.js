...
(function() {
  ...
  module.exports = function(app) {
    var businessDivision1;
    businessDivision1 = ORM.model('businessDivision1');
    app.get(config.apiSubDir + '/v1/businessDivision1s', function(req, res) {
      return async.series([
        function(callback) {
          ...
          switch (userType) {
            case 'superAdmin':
              ...
              return apiExpand(req, res, businessDivision1, params);
    ...
    return app.get(config.apiSubDir + '/v1/businessDivision1s/:id', function(req, res) {
      return async.series([
        function(callback) {
          return apiAuth(req, res, callback);
        }, function(callback) {
