...
(function() {
  ...
  module.exports = function(app) {
    ...
    app.get(config.apiSubDir + '/v1/revisions', function(req, res) {
      return async.series([
        function(callback) {
          ...
          switch (userType) {
            case 'superAdmin':
              ...
              return apiExpand(req, res, revision, params);
    ...
    return app.get(config.apiSubDir + '/v1/revisions/:id', function(req, res) {
      return async.series([
        function(callback) {
          return apiAuth(req, res, callback);
        }, function(callback) {
