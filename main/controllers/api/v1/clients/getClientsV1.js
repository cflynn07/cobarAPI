...
(function() {
  ...
  module.exports = function(app) {
    ...
    app.get(config.apiSubDir + '/v1/clients', function(req, res) {
      return async.series([
        function(callback) {
          ...
          switch (userType) {
            case 'superAdmin':
              ...
              return apiExpand(req, res, client, params);
    ...
    return app.get(config.apiSubDir + '/v1/clients/:id', function(req, res) {
      return async.series([
        function(callback) {
          return apiAuth(req, res, callback);
        }, function(callback) {
          ...
          switch (userType) {
            ...
            case 'clientDelegate':
            case 'clientAuditor':
              if (uids.length > 1 || (uids[0] !== clientUid)) {
