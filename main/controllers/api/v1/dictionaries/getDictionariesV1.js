...
(function() {
  ...
  module.exports = function(app) {
    ...
    app.get(config.apiSubDir + '/v1/dictionaries', function(req, res) {
      return async.series([
        function(callback) {
          ...
          switch (userType) {
            case 'superAdmin':
              ...
              return apiExpand(req, res, dictionary, params);
    ...
    return app.get(config.apiSubDir + '/v1/dictionaries/:id', function(req, res) {
      return async.series([
        function(callback) {
          return apiAuth(req, res, callback);
        }, function(callback) {
